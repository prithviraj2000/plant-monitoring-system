...
const char* ssid = "VITCC-IOT";        // WiFi name
const char* password = "$en$e-505";    // WiFi password
const char* mqtt_server = "mqtt.cloud.kaaiot.com";
const String TOKEN = "mkr1010token";        // Endpoint token - you get (or specify) it during device provisioning
const String APP_VERSION = "c41t4n3efgnu0bit3i7g-v1";  // Application version - you specify it during device provisioning
